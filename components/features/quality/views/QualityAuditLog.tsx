...
export const QualityAuditLog: React.FC = () => {
  ...
  const {
    qualityAuditLogs, totalItems, loadingAuditLogs, auditLogSearch, setAuditLogSearch,
    auditLogSeverityFilter, setAuditLogSeverityFilter, 
  ...
  if (loadingAuditLogs && qualityAuditLogs.length === 0) {
